...
public class StateJump : StateBase
{
    ...
    public override void Execute()
    {
        ...
        _groundDetector.StopIgnoreGround();

        if (Machine.Current == StateMachine.StateType.Crouch && _groundDetector.IsUnderGroundExist())
            _isDownJump = true;
        else
            _isDownJump = false;
    }
    ...
    private StateMachine.StateType JumpWorflow()
    {
        Debug.Log($"StateJump : {Current}");
