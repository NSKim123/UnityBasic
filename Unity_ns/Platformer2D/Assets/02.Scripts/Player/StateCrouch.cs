...
public class StateCrouch : StateBase
{
    ...
    public StateCrouch(StateMachine.StateType machineType, StateMachine machine) : base(machineType, machine)
    {
    ...
    public override bool IsExecuteOK => Machine.Current == StateMachine.StateType.Idle || Machine.Current == StateMachine.StateType.Move;
