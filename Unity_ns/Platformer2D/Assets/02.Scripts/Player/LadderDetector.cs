...
public class LadderDetector : MonoBehaviour
{
    ...
    public Vector2 UpTopStartPos => new Vector2(UpTopPos.x, UpTopPos.y - _detectOffset - _col.offset.y/8.0f);
    public Vector2 DownBottomStartPos => new Vector2(DownBottomPos.x, DownBottomPos.y + _col.offset.y);
    public Vector2 DownTopStartPos => new Vector2( DownTopPos.x, DownTopPos.y - _detectOffset - _col.size.y / 8.0f);
