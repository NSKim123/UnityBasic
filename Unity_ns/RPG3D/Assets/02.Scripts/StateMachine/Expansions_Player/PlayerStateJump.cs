...
public class PlayerStateJump : CharacterStateBase
{
    ...
    public PlayerStateJump(int id, GameObject owner, Func<bool> executeCondition, List<KeyValuePair<Func<bool>, int>> transition) : base(id, owner, executeCondition, transition)
    {
