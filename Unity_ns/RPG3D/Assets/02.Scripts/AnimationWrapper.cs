...
public class AnimationWrapper : MonoBehaviour
{
    ...
    private int _monitorOnStateHash;   //감시자 켜진 상태의 애니메이션 상태의 해쉬코드
    private int _monitorOnStateHashMem; // 감시자 켜졌던 애니메이션 상태의 해쉬코드
    private int _monitorOffStateHash;   //감시자 꺼진 애니메이션 상태의 해쉬코드

    private int _monitorOnMachineHash;   //감시자 켜진 상태의 애니메이션 서브머신의 해쉬코드
    private int _monitorOnMachineHashMem; // 감시자 켜졌던 애니메이션 서브머신의 해쉬코드
    private int _monitorOffMachineHash;   //감시자 꺼진 애니메이션 서브머신의 해쉬코드
